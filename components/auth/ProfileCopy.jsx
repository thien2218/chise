...
const ProfileCopy = ({ imgSrc, handlePreview, handleDeleteImg }) => {
	...
	return (
		<div className="absolute top-0 left-0 w-full -translate-y-[40%] flex justify-center">
         <div className="relative h-32 aspect-square rounded-full overflow-hidden border-[6px] border-white cursor-pointer flex justify-center items-center group">
         ...
         <button
            ...
            className="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-[40%] bg-primary text-white flex justify-center items-center h-6 aspect-square rounded-full"
         >
            <IoClose />
         </button>
		</div>
